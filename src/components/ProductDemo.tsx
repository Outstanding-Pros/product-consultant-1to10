  ...
  ko: [
    {
      ...
      image: '/media/mockups/keyshot-01-analytics-ko.png',
      alt: '애널리틱스 키샷 목업',
    },
    {
      subtitle: 'Benchmark',
      ...
      image: '/media/mockups/keyshot-02-benchmark-ko.png',
      alt: '벤치마크 키샷 목업',
    },
    {
      ...
      image: '/media/mockups/keyshot-03-business-model-ko.png',
      alt: '비즈니스 모델 키샷 목업',
    },
    {
      subtitle: 'Sprint',
      ...
      image: '/media/mockups/keyshot-04-sprint-ko.png',
      alt: '스프린트 키샷 목업',
    },
  ],
  en: [
    {
      ...
      image: '/media/mockups/keyshot-01-analytics-en.png',
    ...
    },
    {
      ...
      image: '/media/mockups/keyshot-02-benchmark-en.png',
    ...
    },
    {
      ...
      image: '/media/mockups/keyshot-03-business-model-en.png',
    ...
    },
    {
      ...
      image: '/media/mockups/keyshot-04-sprint-en.png',
